...
(
    ...
    // --- Signaux de gestion Registres MDIO ( inchangé ) ---
    reg        reg_vld = 0;
    reg  [4:0] reg_addr;
    reg        reg_write;
    reg [15:0] reg_wval;
    ...
    (
        ...
        // Interface AXI TX (Entrées du MAC <- Venant de Echo)
    ...
    // =========================================================================
    // 3. Logique de contrôle des registres (LEDs/Switches) (inchangé)
    // =========================================================================
    ...
    always @* begin
        ...
        case(state)
            STATE_RST: begin
                ...
                reg_vld  = 1;
                reg_addr = sw[4:0]; // Petit fix: cast sw pour éviter warning
                if(reg_ack) begin
                    next_state = STATE_IDLE;
                    next_led   = reg_rval;
                end
