// ============================================================
// frame_processing_style2.v - SANS FILTRE
//
// Workaround : le MAC physique saute le 3eme octet TX.
// On ecrit donc 7 octets pour le Dest MAC en dupliquant
// l'octet 2 aux positions 2 et 3. Apres suppression par le MAC :
//   TX recu [0..5] = r_src_mac[0..5] correct
//
// Trame TX ecrite en RAM (61 octets) :
//   [0]     = r_src_mac[0]
//   [1]     = r_src_mac[1]
//   [2]     = r_src_mac[2]  <- duplique
//   [3]     = r_src_mac[2]  <- duplique
//   [4]     = r_src_mac[3]
//   [5]     = r_src_mac[4]
//   [6]     = r_src_mac[5]
//   [7]     = FPGA_MAC[47:40]
...
//   [13]    = r_etype[0]
//   [14]    = r_etype[1]
//   [15]    = r_payload[0]  (conserve tel quel)
//   [16..60]= r_payload[1..44] + 1
// ============================================================
...
module frame_processing_style2 #(
    ...
    // TX_FRAME_LEN = rx_len + 1 (workaround octet duplique)
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            case (st)
                ...
                P_LOAD: begin
                    tx_len <= rx_len + 1'b1; // latch au premier cycle de P_LOAD
                    case (rx_raddr)
                ...
                P_BUILD: begin
                    ...
                    case (i)
                        // Dest MAC : 7 octets avec duplication de l'octet 2
                        0:  tx_wdata <= r_src_mac[0];
                        1:  tx_wdata <= r_src_mac[1];
                        2:  tx_wdata <= r_src_mac[2]; // duplique
                        3:  tx_wdata <= r_src_mac[2]; // duplique
                        ...
                        // Payload
                        15: tx_wdata <= r_payload[0];       // conserve tel quel
                        16: tx_wdata <= r_payload[1]  + 1;
                        17: tx_wdata <= r_payload[2]  + 1;
                        18: tx_wdata <= r_payload[3]  + 1;
                        19: tx_wdata <= r_payload[4]  + 1;
                        20: tx_wdata <= r_payload[5]  + 1;
                        21: tx_wdata <= r_payload[6]  + 1;
                        22: tx_wdata <= r_payload[7]  + 1;
                        23: tx_wdata <= r_payload[8]  + 1;
                        24: tx_wdata <= r_payload[9]  + 1;
                        25: tx_wdata <= r_payload[10] + 1;
                        26: tx_wdata <= r_payload[11] + 1;
                        27: tx_wdata <= r_payload[12] + 1;
                        28: tx_wdata <= r_payload[13] + 1;
                        29: tx_wdata <= r_payload[14] + 1;
                        30: tx_wdata <= r_payload[15] + 1;
                        31: tx_wdata <= r_payload[16] + 1;
                        32: tx_wdata <= r_payload[17] + 1;
                        33: tx_wdata <= r_payload[18] + 1;
                        34: tx_wdata <= r_payload[19] + 1;
                        35: tx_wdata <= r_payload[20] + 1;
                        36: tx_wdata <= r_payload[21] + 1;
                        37: tx_wdata <= r_payload[22] + 1;
                        38: tx_wdata <= r_payload[23] + 1;
                        39: tx_wdata <= r_payload[24] + 1;
                        40: tx_wdata <= r_payload[25] + 1;
                        41: tx_wdata <= r_payload[26] + 1;
                        42: tx_wdata <= r_payload[27] + 1;
                        43: tx_wdata <= r_payload[28] + 1;
                        44: tx_wdata <= r_payload[29] + 1;
                        45: tx_wdata <= r_payload[30] + 1;
                        46: tx_wdata <= r_payload[31] + 1;
                        47: tx_wdata <= r_payload[32] + 1;
                        48: tx_wdata <= r_payload[33] + 1;
                        49: tx_wdata <= r_payload[34] + 1;
                        50: tx_wdata <= r_payload[35] + 1;
                        51: tx_wdata <= r_payload[36] + 1;
                        52: tx_wdata <= r_payload[37] + 1;
                        53: tx_wdata <= r_payload[38] + 1;
                        54: tx_wdata <= r_payload[39] + 1;
                        55: tx_wdata <= r_payload[40] + 1;
                        56: tx_wdata <= r_payload[41] + 1;
                        57: tx_wdata <= r_payload[42] + 1;
                        58: tx_wdata <= r_payload[43] + 1;
